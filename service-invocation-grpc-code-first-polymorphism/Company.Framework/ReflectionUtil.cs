...
namespace Company.Framework
{
    public static class ReflectionUtil
    {
        ...
        static Func<object, TParamBase, TResultBase> CreateDelegateUnknownTargetDowncastParamUpcastResult<TParamBase, TResultBase>(MethodInfo method)
        {
            ...
            MethodInfo constructedHelper = genericHelper.MakeGenericMethod(method.DeclaringType, method.GetParameters()[0].ParameterType, method.ReturnType, typeof(TParamBase), typeof(TResultBase));
        ...
        static Func<TTargetBase, TResult> CreateDelegateDowncastTarget<TTargetBase, TResult>(MethodInfo method)
        {
            ...
            MethodInfo constructedHelper = genericHelper.MakeGenericMethod(method.DeclaringType, method.ReturnType, typeof(TTargetBase));
